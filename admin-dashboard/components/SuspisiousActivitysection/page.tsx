...
import { Activity, Complaint } from "@/app/types";

/* ✅ Complaints Section */
export function SuspisiousActivitysection({
  activities,
}: {
  activities: Activity[];
}) {
  ...
  return (
    <>
      <Section title="SuspisiousActivity" count={activities.length}>
        {activities.length ? (
            ...
            <table className="min-w-full text-sm">
              <thead className="bg-gray-100 text-gray-600 uppercase text-xs">
                <tr>
                  ...
                  <th className="p-3 text-left font-semibold">Detials</th>
                ...
                {activities.map((c, i) => {
                  c.details = (() => {
                    try {
                      ...
                      return `Reports: ${d.reportCount??d.failedCount}, Period: ${d.period}`;
                    } catch {
                      return c.details;
                    }
                  })();
                  return (
                    ...
                    >
                      ...
                      <td className="p-3 capitalize">{c.details}</td>
                      <td className="p-3">
                        {c.type ? (
                          <Button
                            size="sm"
